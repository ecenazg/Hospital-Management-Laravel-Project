  ...
  return (
    <div className="flex">
      ...
      <div className="flex-grow">
        ...
        <h1 className="text-4xl font-bold mt-8">Welcome to ECE's Hospital</h1>
        <div className="content">
          <div className="slideshow">
            <img src={images[currentPage]} alt={`Slide ${currentPage + 1}`} className="slide-image" />
          ...
          <h2 className="text-2xl font-semibold mt-6">The #1 Hospital Service in Ankara</h2>
        </div>
      </div>
    </div>
  );
